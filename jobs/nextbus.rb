...
def format_time_str(code, times)
  if (code.nil? || times.nil?)
    ...
    code + ': ' + times.sort[0,3].map { |time| time == 0 ? "Due" : "#{time}m"}.join(', ')
  end
end
...
def do_parse(data)
  ...
  #data = {"predictions"=>[{"direction"=>[{"prediction"=>[{"epochTime"=>"1518762231590", "seconds"=>"2197", "minutes"=>"36", "isDeparture"=>"false", "affectedByLayover"=>"true", "branch"=>"24", "dirTag"=>"24_0_24da", "vehicle"=>"8191", "block"=>"24_55_292", "tripTag"=>"35800563"}, {"epochTime"=>"1518762831590", "seconds"=>"2797", "minutes"=>"46", "isDeparture"=>"false", "affectedByLayover"=>"true", "branch"=>"24", "dirTag"=>"24_0_24da", "vehicle"=>"8108", "block"=>"24_42_50", "tripTag"=>"35800564"}, {"epochTime"=>"1518763431590", "seconds"=>"3397", "minutes"=>"56", "isDeparture"=>"false", "affectedByLayover"=>"true", "branch"=>"24", "dirTag"=>"24_0_24da", "vehicle"=>"8187", "block"=>"24_33_152", "tripTag"=>"35800567"}], "title"=>"South - 24 Victoria Park towards Danforth via Victoria Park Station"}, {"prediction"=>[{"epochTime"=>"1518760637843", "seconds"=>"604", "minutes"=>"10", "isDeparture"=>"false", "branch"=>"24", "dirTag"=>"24_0_24A", "vehicle"=>"7778", "block"=>"24_6_60", "tripTag"=>"35800690"}, {"epochTime"=>"1518761438653", "seconds"=>"1405", "minutes"=>"23", "isDeparture"=>"false", "affectedByLayover"=>"true", "branch"=>"24", "dirTag"=>"24_0_24A", "vehicle"=>"7795", "block"=>"24_7_70", "tripTag"=>"35800691"}, {"epochTime"=>"1518761786078", "seconds"=>"1752", "minutes"=>"29", "isDeparture"=>"false", "affectedByLayover"=>"true", "branch"=>"24", "dirTag"=>"24_0_24A", "vehicle"=>"7752", "block"=>"24_41_90", "tripTag"=>"35800692"}], "title"=>"South - 24 Victoria Park towards Victoria Park Station"}], "agencyTitle"=>"Toronto Transit Commission", "routeTitle"=>"24-Victoria Park", "routeTag"=>"24", "stopTitle"=>"Victoria Park Ave At Lawrence Ave East", "stopTag"=>"1401"}, {"agencyTitle"=>"Toronto Transit Commission", "routeTitle"=>"324-Victoria Park Night Bus", "routeTag"=>"324", "stopTitle"=>"Victoria Park Ave At Lawrence Ave East", "stopTag"=>"1401", "dirTitleBecauseNoPredictions"=>"South - 324 Victoria Park Blue Night towards Kingston Rd"}], "copyright"=>"All data copyright Toronto Transit Commission 2018."}
